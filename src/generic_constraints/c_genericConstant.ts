...
function marginal<U extends object, V extends object>(obj1:U,obj2:V){
  //marginal<U extends object, V extends object> คือ parameter U ทำการดึงข้อมูลจาก U ที่เป็น object หรือถ้าตามนี้คือการดึงข้อมูลจากตัวที่ใส่ใน parameter function/ V ทำเหมือน U
